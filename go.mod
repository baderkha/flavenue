module github.com/baderkha/flavenue

go 1.20

require (
	github.com/baderkha/easy-gin v0.1.13 // indirect
	github.com/baderkha/library v0.0.0-20220829184046-34077659bf01 // indirect
